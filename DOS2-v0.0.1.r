...
pacman::p_load('cluster', 'mclust', 'e1071', 'fpc', 'dplyr', 'readxl', 'sqldf', 'tidyr')
...
loblaw_raw_data_1 <- sqldf("select LowPrices, Freshness, ChoiceVariety, Healthiness, OrganicAlternatives, ConvenientStoreLayout, StoreLocation, ProductQuality, ServiceQuality, ReturnPolicy, Cleanliness, Busyness, 
                      ActivePerson, NoActivePerson, PhysicallyFit, EatHealthy, HealthyPerson, EatPoorly, FruitsAndVegetables, HoursOfExercise, neighbourhood, maritalStatus, gender, age, familySize, occupationCategory, HighestDegree, HouseHoldAnualIncome from loblaw_raw_data")
...
loblaw_raw_data_attributes <- sqldf("select ActivePerson, NoActivePerson, PhysicallyFit, EatHealthy, HealthyPerson, EatPoorly, FruitsAndVegetables, HoursOfExercise, neighbourhood, maritalStatus, gender, age, familySize, occupationCategory, HighestDegree, HouseHoldAnualIncome from loblaw_raw_data")
